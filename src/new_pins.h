...
typedef enum ioRole_e {
  ...
  // iodetail:{"name":"Relay",
  // iodetail:"title":"TODO",
  // iodetail:"descr":"an active-high relay. This relay is closed when a logical
  // 1 value is on linked channel",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"a typical button of Tuya device with active-low state (a
  // button that connects IO pin to ground when pressed and also has a 10k or so
  // pull up resistor)",
  ...
  // iodetail:{"name":"LED",
  // iodetail:"title":"TODO",
  // iodetail:"descr":"an active-high LED. The internals of 'LED' are the same
  // as of 'Relay'. Names are just separate to make it easier for users.",
  ...
  // iodetail:{"name":"PWM",
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Pulse width modulation output for LED dimmers (with MQTT
  // dimming support from Home Assistant). Remember to set related channel to
  // correct color index, in the RGBCW order. For CW only lights, set only CW
  // indices.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"special LED to indicate WLan connection state. LED states
  // are following: LED on = client mode successfully connected to your Router.
  // Half a second blink - connecting to your router, please wait (or connection
  // problem). Fast blink (200ms) - open access point mode. In safe mode (after
  // failed boots), LED might not work.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"this is a simple digital input pin, it sets the linked
  // channel to current logical value on it, just like digitalRead( ) from
  // Arduino. This input has a internal pull up resistor.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"this pin will toggle target channel when a value on this
  // pin changes (with debouncing). you can connect simple two position switch
  // here and swapping the switch will toggle target channel relay on or off",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"As DigitalInput, but without internal programmable pullup
  // resistor. This is used for, for example, XR809 water sensor and door
  // sensor.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"As DigitalInput_n, but without internal programmable
  // pullup resistor",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"SEL pin for BL0937 energy measuring devices. Set all
  // BL0937 pins to autostart BL0937 driver. Don't forget to calibrate it
  // later.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"CF pin for BL0937 energy measuring devices. Set all
  // BL0937 pins to autostart BL0937 driver. Don't forget to calibrate it
  // later.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"CF1 pin for BL0937 energy measuring devices. Set all
  // BL0937 pins to autostart BL0937 driver. Don't forget to calibrate it
  // later.",
  ...
  // iodetail:{"name":"ADC",
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Analog to Digital converter converts voltage to channel
  // value which is later published by MQTT and also can be used to trigger
  // scriptable events",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"SM2135 DAT pin for SM2135 modified-I2C twowire LED
  // driver, used in RGBCW lights. Set both required SM2135 pins to autostart
  // the related driver. Don't forget to Map the colors order later, so colors
  // are not mixed.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"SM2135 CLK pin for SM2135 modified-I2C twowire LED
  // driver, used in RGBCW lights. Set both required SM2135 pins to autostart
  // the related driver. Don't forget to Map the colors order later, so colors
  // are not mixed.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"BP5758D DAT pin for BP5758D modified-I2C twowire LED
  // driver, used in RGBCW lights. Set both required BP5758D pins to autostart
  // the related driver. Don't forget to Map the colors order later, so colors
  // are not mixed.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"BP5758D CLK pin for BP5758D modified-I2C twowire LED
  // driver, used in RGBCW lights. Set both required BP5758D pins to autostart
  // the related driver. Don't forget to Map the colors order later, so colors
  // are not mixed.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"BP1658CJ DAT pin for BP5758D modified-I2C twowire LED
  // driver, used in RGBCW lights. Set both required BP1658CJ pins to autostart
  // the related driver. Don't forget to Map the colors order later, so colors
  // are not mixed.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"BP1658CJ CLK pin for BP5758D modified-I2C twowire LED
  // driver, used in RGBCW lights. Set both required BP1658CJ pins to autostart
  // the related driver. Don't forget to Map the colors order later, so colors
  // are not mixed.",
  ...
  // iodetail:{"name":"PWM_n",
  // iodetail:"title":"TODO",
  // iodetail:"descr":"as above, but percentage of duty is inversed. This might
  // be useful for some special LED drivers that are using single PWM to choose
  // between Cool white and Warm white (it also needs setting a special flag in
  // General options)",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"for RGB strip with buttons; sets next predefined color.
  // For a LED strip that has separate POWER and COLOR buttons.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"for RGB strip with buttons; when hold, adjusts the
  // brightness",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"WIP driver, write a post on Elektroda if you need it
  // working",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Button that automatically allows you to control
  // temperature of your LED device",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"This button does nothing automatically, even the linked
  // channel is not changed. Useful for scripts, but you can still also use any
  // buttons for scripting.",
  ...
  // iodetail:{"name":"DHT11",
  // iodetail:"title":"TODO",
  // iodetail:"descr":"DHT11 data line. You can have multiple DHT sensors on
  // your device. Related driver is automatically started. Results are saved in
  // related channels to pin with that role (when editing pins, you get two
  // textboxes to set channel indexes)",
  ...
  // iodetail:{"name":"DHT12",
  // iodetail:"title":"TODO",
  // iodetail:"descr":"DHT12 data line. You can have multiple DHT sensors on
  // your device. Related driver is automatically started. Results are saved in
  // related channels to pin with that role (when editing pins, you get two
  // textboxes to set channel indexes)",
  ...
  // iodetail:{"name":"DHT21",
  // iodetail:"title":"TODO",
  // iodetail:"descr":"DHT21 data line. You can have multiple DHT sensors on
  // your device. Related driver is automatically started. Results are saved in
  // related channels to pin with that role (when editing pins, you get two
  // textboxes to set channel indexes)",
  ...
  // iodetail:{"name":"DHT22",
  // iodetail:"title":"TODO",
  // iodetail:"descr":"DHT22 data line. You can have multiple DHT sensors on
  // your device. Related driver is automatically started. Results are saved in
  // related channels to pin with that role (when editing pins, you get two
  // textboxes to set channel indexes)",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"DAT pin of CHT83XX. Setting this pin role and saving will
  // reveal two fields next to it. Set first field to 1 and second to 2. Those
  // are related channel numbers to store temperature and humidity.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Humidity/temperature sensor DATA pin. Driver will
  // autostart if both required pins are set. See [SHT Sensor tutorial topic
  // here](https://www.elektroda.com/rtvforum/topic3958369.html), also see [this
  // sensor teardown](https://www.elektroda.com/rtvforum/topic3945688.html)",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Humidity/temperature sensor CLOCK pin. Driver will
  // autostart if both required pins are set. See [SHT Sensor tutorial topic
  // here](https://www.elektroda.com/rtvforum/topic3958369.html), also see [this
  // sensor teardown](https://www.elektroda.com/rtvforum/topic3945688.html)",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Generic software SDA pin for our more advanced,
  // scriptable I2C driver. This allows you to even connect a I2C display to
  // OBK.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Generic software SCL pin for our more advanced,
  // scriptable I2C driver.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"It works for both SM2235 and SM2335. SM2235 DAT pin for
  // SM2235 modified-I2C twowire LED driver, used in RGBCW lights. Set both
  // required SM2235 pins to autostart the related driver. Don't forget to Map
  // the colors order later, so colors are not mixed.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"It works for both SM2235 and SM2335. SM2235 CLK pin for
  // SM2235 modified-I2C twowire LED driver, used in RGBCW lights. Set both
  // required SM2235 pins to autostart the related driver. Don't forget to Map
  // the colors order later, so colors are not mixed.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Motor/Relay bridge driver control signal. FORWARD
  // direction.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Motor/Relay bridge driver control signal. REVERSE
  // direction.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"A single button that does all control for LED. Click it
  // toggle power, hold to adjust brightness, double click for next color,
  // triple click for next temperature",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Setting this role will make DoorSensor driver autostart.
  // DoorSensor will work like digital input, sending only its value on change.
  // When there are no changes for some times, device will go into deep sleep to
  // save battery. When a change occurs, device will wake up and report change.
  // See [a door sensor example
  // here](https://www.elektroda.com/rtvforum/topic3960149.html)",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Like ADC, but for a Battery driver that does Battery
  // measurement. See [battery driver topic
  // here](https://www.elektroda.com/rtvforum/topic3959103.html)",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Like Relay, but for a Battery driver that does Battery
  // measurement. See [battery driver topic
  // here](https://www.elektroda.com/rtvforum/topic3959103.html)",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"TM1637 LED display driver DIO pin. Setting all required
  // TM1637 pins will autostart related driver",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"TM1637 LED display driver CLK pin. Setting all required
  // TM1637 pins will autostart related driver",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Inverted SEL alternative for BL0937. Choose only one,
  // either SEL or SEL_n. SEL_n may be needed in rare cases.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"SGP Quality Sensor Clock line. will autostart related
  // driver",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"SGP Quality Sensor Data line. will autostart related
  // driver",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Like BAT_Relay, but inversed. See [battery driver topic
  // here](https://www.elektroda.com/rtvforum/topic3959103.html)",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"KP18058 LED linear constant current dimming chip with I2C
  // interface - CLK pin",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Counts pulses on falling edge (transition from high to
  // low). Each transitions adds 1 to linked channel.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"Counts pulses on rising edge (transition from low to
  // high). Each transitions adds 1 to linked channel.",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"This is an output pin which has current led_enableAll
  // value",
  ...
  // iodetail:"title":"TODO",
  // iodetail:"descr":"This is an output pin which has negation of current
  // led_enableAll value",
...
#define IS_PIN_TEMP_HUM_SENSOR_ROLE(role)                                      \
  (((role) == IOR_SHT3X_DAT) || ((role) == IOR_CHT83XX_DAT))
#define IS_PIN_AIR_SENSOR_ROLE(role) (((role) == IOR_SGP_DAT))

typedef enum channelType_e {
  // chandetail:{"name":"Default",
  // chandetail:"title":"TODO",
  // chandetail:"descr":"Default channel type. This channel type is often used
  // in simple devices and is suitable for relays. You don't need to use
  // anything else for most of the non-TuyaMCU devices.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This channel type represents a temperature in degrees.
  // The temperature is shown as a read only, integer value on WWW panel.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This channel type represents a humidity in percent. The
  // humidity is shown as a read only, integer value on WWW panel.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This is also humidity, but in TuyaMCU format,
  // multiplied by 10, so 554 is 55.4%. Main WWW panel displays it correctly. If
  // you want multiplied value to be published to MQTT, check flags.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This channel will show ON/OFF toggle, so it is very
  // much like default channel type, but the toggle will be always shown, even
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"A custom dimmer channel. This will have a 0-100 range
  // and will show a slider. The slider value will be saved to channel, but
  // nothing else is done automatically. You can map it to TuyaMCU dpID to get
  // dimming working or script it however you like.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This channel has 3 values: 0, 1 and 2. This will show
  // radio selection with those 3 options on the main WWW panel.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This is a custom textfield channel, where you can type
  // any value. Used for testing, can be also used for time countdown on TuyaMCU
  // devices. Text field will be shown on main WWW panel",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This channel is read only. It will just print its value
  // on main WWW page. Of course, you can still write to it with console
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"Like LowMidHigh, but with 4 options. Some of TuyaMCU
  // fans might require that.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"Like LowMidHigh, but more options. Some of TuyaMCU fans
  // might require that.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"Just like dimmer, but it's using 0-255 range.
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"Just like dimmer, but it's using 0-1000 range.
  // Everything else is the same.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"For TuyaMCU power metering. Not used for BL09** and
  // CSE** sensors. Divider is used by TuyaMCU, because TuyaMCU sends always
  // values as integers so we have to divide them before displaying on UI",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This will show an 'Open' or 'Closed' string on main WWW
  // panel. Useful for door sensors, etc.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This will show current value as a battery level percent
  // on the main WWW panel.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"Like LowMidHigh, but with 5 options. Some of TuyaMCU
  // fans might require that.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"Just like power, but with one decimal place (but stored
  // as integer, for TuyaMCU support)",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"Radio buttons with 3 options: off, on and 'remember'.
  // This is used for TuyaMCU memory state",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"Just like ChType_Temperature_div10, but for multiplied
  // by 0.5.",
  ...
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This will display time formatted to minutes, hours,
  // etc.",
  ...
  // chandetail:"descr":"This channel type allows creating custom Enum types in
  // combination with SetChannelEnum command. Ideal for defining TuyaMCU enum
  // mappings.",
  ...
  // chandetail:"descr":"Read Only Enum Channel type for use in combination with
  // SetChannelEnum command. Ideal for defining TuyaMCU enum mappings.",
  ...
  // chandetail:{"name":"Max",
  // chandetail:"title":"TODO",
  // chandetail:"descr":"This is the current total number of available channel
  // types.",
...
#ifdef JWGB2
#define MODEL "JWGB2"
#define HARDWARE "JWGB_BEKEN_T1_U_HL_MCU_IPX"
#endif
...
// RGBCW access (well, in reality, we just use RGB access and CW is derived from
// temp)
...
typedef struct led_corr_s { // LED gamma correction and calibration data block
  float
      rgb_cal[3];  // RGB correction factors, range 0.0-1.0, 1.0 = no correction
...
typedef struct mainConfig_s {
  ...
  // offset 0x000004BC
  unsigned long
      LFS_Size; // szie of LFS volume.  it's aligned against the end of OTA
  int loggerFlags;
#if PLATFORM_W800 || PLATFORM_BK7252 || PLATFORM_BK7252N || PLATFORM_XR872
...
void CHANNEL_SetFirstChannelByTypeEx(int requiredType, int newVal,
                                     int ausemovingaverage);
