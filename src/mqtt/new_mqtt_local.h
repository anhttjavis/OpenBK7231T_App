#ifndef __NEW_MQTT_LOCAL_H__
#define __NEW_MQTT_LOCAL_H__
...
extern ip_addr_t mqtt_ip_local;
extern mqtt_client_t* mqtt_client_local;
...
OBK_Publish_Result MQTT_PublishMain_StringInt_local(const char* sChannel, int val);
...
OBK_Publish_Result MQTT_Publish_local(const char* sTopic, const char* sChannel, const char* value, int flags);
...
extern int g_mqtt_bBaseTopicDirty_local;
extern int mqtt_reconnect_local;
extern int mqtt_loopsWithDisconnected_local;
